...
import 'package:onlineshop/views/shared/checkout_btn.dart';
...
class _ProductPageState extends State<ProductPage> {
  ...
  late Future<BikeProduct> _bikeprdct;

  void getShoes() {
    if (widget.category == "Bike Essentials") {
      _bikeprdct = Helper().getEssentialsSneakersById(widget.id);
    } else if (widget.category == "Bike Styles") {
      _bikeprdct = Helper().getStylesSneakersById(widget.id);
    } else {
      _bikeprdct = Helper().getUpgradesById(widget.id);
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        body: FutureBuilder<BikeProduct>(
            future: _bikeprdct,
